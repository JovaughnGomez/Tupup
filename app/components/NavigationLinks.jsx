  ...
  return (
    <>
        {useDefaultNav ? (
            ...
            <div id={id} className={`${styles.welcome}`}>
                <ul className={styles.user_menu}>
                    <Link className={`toggleSidebar ${linkPath == index ? styles.activeNav : ""}`} href="/member/manage/profile">
                        <span className={styles.navTextStyle}> 
                            <span className={styles.nav_icon_wrp}> 
                                <Icon className={styles.nav_icons} path={mdiAccount} size={1} /> 
                            </span> 
                    ...
                    <Link className={`toggleSidebar ${linkPath == index ? styles.activeNav : ""}`} href="/member/manage/change-password">
                        <span className={styles.navTextStyle}> 
                            <span className={styles.nav_icon_wrp}> 
